...
public class PlayerService implements PlayerRepository {
    ...
    public ArrayList<Player> getPlayers(){
        Collection<Player> playersCollections= team.values();
        ArrayList<Player> player = new ArrayList<>(playersCollections);
        return player;
    }
    ...
    public Player updatePlayer(int playerId,Player player){
        ...
        if(existingPlayer==null) throw new ResponseStatusException(HttpStatus.NOT_FOUND);
